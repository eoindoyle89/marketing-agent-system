...
Before working on pricing, read `../shared/context-read-protocol.md` and
follow it.
...
context store is available. Treat pricing work as requiring the `Pricing, offers, launch,
...
Also load `product-capabilities-and-funnel.md`,
`marketing-operations.md`, `campaign-history.md`, and `sources.md` when present. Ask for missing pricing
authority, margin constraints, billing capabilities, and effective dates
before recommending pricing changes. Recommendations are proposals; live
pricing changes need explicit approval and recorded effective dates in
`offers-pricing-and-packaging.md`.
