...
Also load `competitive-context.md`, `case-studies.md`,
`visual-identity-and-assets.md`, `marketing-operations.md`, `brand-voice.md`,
`qa-policy.md`, and `sources.md` when present. Ask for missing launch date,
product readiness boundaries, embargoes, and approval details before building
the launch plan. Plan and draft only; do not publish, submit listings, or
contact press or partners.
