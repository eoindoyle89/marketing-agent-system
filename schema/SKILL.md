...
Before implementing schema, read `../shared/context-read-protocol.md` and
follow it.
...
- conditional files triggered by the task, especially `case-studies.md`,
  `sources.md`, `offers-pricing-and-packaging.md`, and
...
rule. Ask only for missing details that materially affect this schema task. Do
