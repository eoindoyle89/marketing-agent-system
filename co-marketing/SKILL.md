...
Also load `proof-points.md`, `case-studies.md`,
`channel-rules.md`, `campaign-history.md`, `brand-voice.md`, and `sources.md` when present. Ask for missing partner
permissions, brand-use rights, and approval details before proposing joint
campaigns. Do not contact partners, and do not use a partner's name, logo,
audience data, or customer evidence in drafts unless permission is recorded.
...
Use connected partner-platform tools only when they are available in the current
...
| Tool | Best For |
|------|----------|
| **Crossbeam** | Account overlap with partners |
| **Introw** | Partner program management, deal registration |
| **PartnerStack** | Partner and affiliate program management |
