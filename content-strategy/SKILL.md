...
- `proof-points.md`;
- `campaign-history.md`;
- conditional files triggered by the task, especially `public-asset-audit.md`,
  `competitive-context.md`, `goals-metrics-and-funnel.md`,
...
rule. Ask only for missing details that materially affect this content strategy.
