...
Before drafting PR material, read `../shared/context-read-protocol.md` and
follow it.
...
context store is available. Treat PR work as requiring the `Content strategy, copy, social,
...
Also load `case-studies.md`, `campaign-history.md`,
`public-asset-audit.md`, `visual-identity-and-assets.md`, `qa-policy.md`, and
`sources.md` when present. Ask for missing
spokesperson availability, embargo and timing constraints, and approval details
before drafting pitches or press material. Draft only; do not pitch, contact
journalists, or distribute releases. Treat outlet lists and journalist details
in references as examples needing currentness checks, not maintained data.
