...
Before designing a programmatic SEO strategy, read
...
- conditional files triggered by the task, especially `competitive-context.md`,
  `customer-research-and-voc.md`, `offers-pricing-and-packaging.md`,
  `proof-points.md`, `case-studies.md`, and `marketing-operations.md`.
...
rule. Ask only for missing details that materially affect this programmatic SEO
task. Do not use chat memory, public observations, or fallback configuration as
