...
- conditional files triggered by the task, especially `competitive-context.md`,
  `customer-research-and-voc.md`, `visual-identity-and-assets.md`,
  `proof-points.md`, and `sources.md`.
...
rule. Ask only for missing details that materially affect this ASO task. Do not
use chat memory, public observations, or fallback configuration as approved
company truth.
