...
Before planning lead magnets, read `../shared/context-read-protocol.md` and
follow it.
...
context store is available. Treat lead-magnet work as requiring the `Content strategy, copy, social,
...
Also load `goals-metrics-and-funnel.md`, `brand-voice.md`,
`anti-ai-writing-rules.md`, `marketing-operations.md`, `qa-policy.md`, and
`sources.md` when present. Ask for missing data-capture
and consent policy, distribution channels, and follow-up sequence ownership
before recommending a lead magnet.
