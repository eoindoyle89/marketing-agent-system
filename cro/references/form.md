...
Read `../shared/context-read-protocol.md` from the skill root and use
`.agent-context/INDEX.md` when a context store is available. Load
`product-capabilities-and-funnel.md`, `goals-metrics-and-funnel.md`,
`customer-research-and-voc.md`, `brand-voice.md`, and `qa-policy.md` before
asking questions.
