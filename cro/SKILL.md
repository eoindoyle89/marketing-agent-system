...
Before auditing conversion paths, read `../shared/context-read-protocol.md` and
follow it.

Use `.agent-context/INDEX.md` as the primary company context source when a
context store is available. Treat CRO work as requiring the `Paid media,
...
`campaign-history.md`, `qa-policy.md`, and `sources.md` when present. Ask for
missing traffic source, page URL, baseline conversion, analytics, and
implementation constraints before recommending changes.
