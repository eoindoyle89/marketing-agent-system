...
Also load `positioning-and-icp.md`, `campaign-history.md`,
`marketing-operations.md`, `channel-rules.md`, and `sources.md` when present.
Ask for missing entitlement, billing, conversion, compliance, and product-state
details before recommending paywall changes.
