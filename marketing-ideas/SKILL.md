...
`competitive-context.md`, and `sources.md` when present. Ask for missing budget,
team-capacity, and channel-state details before recommending ideas. Score
ideas against recorded goals and capacity, not generic best practice.
