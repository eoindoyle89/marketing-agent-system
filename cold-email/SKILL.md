...
Before writing cold outreach, read `../shared/context-read-protocol.md` and
follow it.
...
context store is available. Treat cold outreach work as requiring the `Sales enablement, outbound,
...
Also load `competitive-context.md`, `channel-rules.md`,
`goals-metrics-and-funnel.md`, `marketing-operations.md`, `qa-policy.md`, and
`sources.md` when present. Ask for missing prospect-list
source, lawful-basis and compliance constraints for the target jurisdictions,
sending infrastructure, volume, and approval details before drafting outreach.
Draft only; do not send outreach or contact prospects.
...
- **marketing-system-setup**: For building durable positioning and company context
