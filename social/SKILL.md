...
- conditional files triggered by the task, especially `case-studies.md`,
  `campaign-history.md`, `public-asset-audit.md`,
  `visual-identity-and-assets.md`, and `marketing-operations.md`.
...
rule. Ask only for missing details that materially affect this social task. Do
