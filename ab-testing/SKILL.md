...
Before designing experiments, read `../shared/context-read-protocol.md` and
follow it.

Use `.agent-context/INDEX.md` as the primary company context source when a
context store is available. Treat experimentation as requiring the `Paid media,
...
Also load `public-asset-audit.md`, `customer-research-and-voc.md`,
`channel-rules.md`, `proof-points.md`, and `sources.md` when present. Ask for
missing baseline, traffic, metric, tool, implementation, and approval details
