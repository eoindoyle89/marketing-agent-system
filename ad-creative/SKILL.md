...
Before producing ad creative, read `../shared/context-read-protocol.md` and
follow it.
...
Also load `competitive-context.md`, `public-asset-audit.md`,
`goals-metrics-and-funnel.md`, `qa-policy.md`, and `sources.md` when present.
Ask for missing platform, format, creative inventory, rights, performance, and
approval details before producing or presenting creative.
...
Use connected ad-platform tools only when they are available in the current
runtime. If no connector is available, ask for exported performance data,
screenshots, pasted results, or a creative inventory before iterating.

| Platform | Performance Inputs | Management Boundary |
|----------|--------------------|---------------------|
| **Google Ads** | RSA assets, impressions, CTR, conversions, CPA/ROAS | Do not upload without explicit user approval |
| **Meta Ads** | Hooks, primary text, creative IDs, spend, CTR, CVR, CPA/ROAS | Do not upload without explicit user approval |
| **LinkedIn Ads** | Creative, audience, engagement, lead quality, CPL | Do not upload without explicit user approval |
| **TikTok Ads** | Hook retention, watch time, CTR, CVR, CPA/ROAS | Do not upload without explicit user approval |

### Workflow: Pull Data, Analyze, Generate

1. Pull or request recent ad performance.
2. Identify top and bottom creative patterns.
3. Map winning patterns back to audience, offer, and channel context.
4. Generate new variations.
5. Present for approval before any upload or launch.
