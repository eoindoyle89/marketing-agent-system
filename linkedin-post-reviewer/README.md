...
where it reads as a conclusion. Pairing it with
[linkedin-ghostwriter](../linkedin-ghostwriter/) is the point: one writes, the
other judges, and the judge doesn't soften.
