...
Before designing referral or affiliate programs, read `../shared/context-read-protocol.md` and
follow it.

Use `.agent-context/INDEX.md` as the primary company context source when a
context store is available. Treat referral-program work as requiring the `Pricing, offers, launch,
...
Also load `proof-points.md`, `channel-rules.md`,
`campaign-history.md`, `brand-voice.md`, `qa-policy.md`, and `sources.md` when present. Ask for missing incentive
budget and approval authority, legal and tax constraints for rewards, and
tracking capability before designing incentives. Program designs are
proposals; record approved incentives in `offers-pricing-and-packaging.md`.
...
Use connected referral- and affiliate-platform tools only when they are available in the current
runtime. If no connector is available, ask the user for platform exports,
screenshots, or settings before making account-specific recommendations.
Common platforms:
