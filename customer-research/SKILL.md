...
- conditional files triggered by the task, especially
  `product-capabilities-and-funnel.md`, `competitive-context.md`,
  `proof-points.md`, `case-studies.md`, and `public-asset-audit.md`.
...
rule. Ask only for missing details that materially affect this research task.
