...
app stores` when the request is primarily search-content driven.
...
- conditional files triggered by the task, especially `case-studies.md`,
  ...
  `public-asset-audit.md`, and `channel-rules.md`.
...
rule. Ask only for missing details that materially affect this competitor page.
