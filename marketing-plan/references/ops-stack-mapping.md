...
|---|---|---|
| `marketing-system-setup` | Provision the `.agent-context/` company store (positioning, ICP, voice, proof) | Foundational — run first; every section of the plan references this |
...
| **Notes tooling** | Working notes for fCMO (any durable notes system) |
