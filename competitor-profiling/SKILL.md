...
site architecture, app stores` when the request is primarily search/content
...
- `sources.md`;
- conditional files triggered by the task, especially
  `offers-pricing-and-packaging.md`, `public-asset-audit.md`,
  `customer-research-and-voc.md`, and `proof-points.md`.
...
rule. Ask only for missing details that materially affect this competitor
profile. Do not use chat memory, public observations, or fallback configuration
as approved company truth.
