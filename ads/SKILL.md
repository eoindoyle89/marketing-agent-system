...
context store is available. Treat paid-media work as requiring the `Paid media,
...
Also load `campaign-history.md`, `competitive-context.md`,
`marketing-operations.md`, `qa-policy.md`, and `sources.md` when present.
Ask for missing budget, approval, tracking, compliance, and account-access
details before making live-account recommendations.
...
Use connected ad-platform, analytics, or warehouse tools only when they are
available in the current runtime. If no connector is available, ask the user for
exports, screenshots, pasted campaign data, or access instructions before
making account-specific recommendations.

| Platform | Best For | Data Needed |
|----------|----------|-------------|
| **Google Ads** | Search intent, high-intent traffic | Campaign structure, keywords, search terms, conversions, spend |
| **Meta Ads** | Demand gen, visual products, B2C | Campaign/ad-set/ad performance, creative history, audience, pixel events |
| **LinkedIn Ads** | B2B, job title targeting | Campaign groups, audiences, lead quality, offline conversion data |
| **TikTok Ads** | Younger demographics, video | Creative performance, audience, hook retention, conversion data |
