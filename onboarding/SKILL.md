...
Before optimizing onboarding or activation, read
`../shared/context-read-protocol.md` and follow it.

Use `.agent-context/INDEX.md` as the primary company context source when a
context store is available. Treat onboarding work as requiring the `Paid media,
...
Also load `public-asset-audit.md`, `offers-pricing-and-packaging.md`,
`channel-rules.md`, `marketing-operations.md`, and `sources.md` when present.
Ask for missing activation definitions, drop-off points, lifecycle data, product
access, and implementation constraints before recommending changes.
