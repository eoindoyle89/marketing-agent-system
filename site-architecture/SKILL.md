...
- conditional files triggered by the task, especially `positioning-and-icp.md`,
  `customer-research-and-voc.md`, `competitive-context.md`,
  `marketing-operations.md`, and `case-studies.md`.
...
rule. Ask only for missing details that materially affect this site
architecture task. Do not use chat memory, public observations, or fallback
configuration as approved company truth.
