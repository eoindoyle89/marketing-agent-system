...
churn` when the request is conversion-flow specific.
...
- conditional files triggered by the task, especially
  `offers-pricing-and-packaging.md`, `product-capabilities-and-funnel.md`,
  `case-studies.md`, `campaign-history.md`, `public-asset-audit.md`, and
...
rule. Ask only for missing details that materially affect this copy task. Do
not use chat memory, public observations, or fallback configuration as approved
company truth.
