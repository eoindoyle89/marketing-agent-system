...
Before optimizing signup, read `../shared/context-read-protocol.md` and
follow it.

Use `.agent-context/INDEX.md` as the primary company context source when a
context store is available. Treat signup optimization as requiring the `Paid
media, conversion, and measurement` task family.
...
`campaign-history.md`, `marketing-operations.md`, and `sources.md` when present.
Ask for missing flow, completion, drop-off, tool, consent, and data-collection
requirements before recommending changes.
