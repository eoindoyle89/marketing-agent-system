...
Before designing email sequences, read `../shared/context-read-protocol.md` and
follow it.
...
context store is available. Treat lifecycle email work as requiring the `Content strategy, copy, social,
email, PR` task family.
...
Also load `case-studies.md`, `campaign-history.md`, `marketing-operations.md`,
`qa-policy.md`, and `sources.md` when present. Ask for missing list, consent
and opt-in status, sending platform, lifecycle triggers, and approval details
before recommending or drafting a sequence. Draft only; do not send email or
change live automations without explicit human approval.
...
Use connected email-platform tools only when they are available in the current
