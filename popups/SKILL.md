...
Also load `proof-points.md`, `campaign-history.md`,
`marketing-operations.md`, and `sources.md` when present. Ask for missing page,
traffic, trigger, consent, frequency, mobile, and measurement details before
