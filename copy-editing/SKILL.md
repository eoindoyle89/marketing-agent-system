...
Before editing, read `../shared/context-read-protocol.md` and follow it.
...
- conditional files triggered by the task, especially `case-studies.md`,
  ...
  `offers-pricing-and-packaging.md`, and `visual-identity-and-assets.md`.
...
rule. Ask only for missing details that materially affect this edit. Do not use
