...
- conditional files triggered by the task, especially `competitive-context.md`,
  `case-studies.md`, `sources.md`, `channel-rules.md`, and
...
rule. Ask only for missing details that materially affect this AI search task.
Do not use chat memory, public observations, or fallback configuration as
...
For implementation, use the connected company's existing web stack and deployment process.
