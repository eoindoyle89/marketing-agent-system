...
- conditional files triggered by the task, especially
  `offers-pricing-and-packaging.md`, `channel-rules.md`,
  `marketing-operations.md`, `competitive-context.md`, and `sources.md`.
...
rule. Ask only for missing details that materially affect this directory
submission task. Do not use chat memory, public observations, or fallback
