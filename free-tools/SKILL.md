...
Before planning a free tool, read `../shared/context-read-protocol.md` and
follow it.
...
context store is available. Treat free-tool work as requiring the `SEO, AI search, site
architecture, app stores` task family.
...
`competitive-context.md`, `channel-rules.md`, and `sources.md` when present. Ask for missing engineering
capacity, maintenance ownership, and attribution rules before recommending a
tool investment.
